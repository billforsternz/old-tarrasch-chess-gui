...
static int window_id_positions_54[NBR_OF_WIDS][4] =
{
    {32,11,435,435},                // gb
    {10,10,20,20},                  // who_top
    {10,422,20,20},                 // who_bottom
    {32,454,206,22},                // white_player
    {238,454,20,22},                // dash_player
    {258,454,206,22},               // black_player
    {10,478,674,37},                // box
    {20,488,286,22},                // status
    {10,425,116,19},                // book_moves
    {512,450,68,28},                // wclock 
    {584,450,68,28},                // bclock 
    {470,10,216,435},               // moves          + 3
    {394,488,0,0},                  // button                       
    {10,518,578,99},                // kibitz
    {600,540,60,20},                // kibitz_button1
    {600,568,60,20}                 // kibitz_button2
};
...
(
    ...
    : wxScrolledWindow( parent, id, point, siz, wxSUNKEN_BORDER )
{
    resize_ready = false;
    popup = NULL;
    lb = NULL;
